...
public class PlayerActivity_Rock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivity = PlayerActivity_Rock.this;
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Отклчение клавиши Play и включение клавиши Stop
                startButton.setEnabled(false);
                stopButton.setEnabled(true);

                // URL аудиостанции
                String audioUrl = "http://eu7.fastcast4u.com:6249/;stream.mp3";
